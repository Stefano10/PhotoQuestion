...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerTesteViewHolder> {
    ...
    Context mctx;
    private List<Pergunta> mList;

    public RecyclerAdapter(Context ctx, List<Pergunta> list, ClickRecyclerView_Interface clickRecyclerViewInterface) {
        this.mctx = ctx;
        this.mList = list;
    ...
    public void onBindViewHolder(RecyclerTesteViewHolder viewHolder, int i) {
        Pergunta Pergunta = mList.get(i);

        viewHolder.viewNome.setText(Pergunta.getTitulo());
    ...
    protected class RecyclerTesteViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerTesteViewHolder(final View itemView) {
            ...
            viewNome = (TextView) itemView.findViewById(R.id.tituloLista);
